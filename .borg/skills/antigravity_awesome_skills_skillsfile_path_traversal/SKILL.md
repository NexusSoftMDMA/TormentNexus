---
name: antigravity_awesome_skills_skillsfile_path_traversal
description: Curated skill skills/file-path-traversal from sickn33/antigravity-awesome-skills
---

# Antigravity Awesome Skills Skillsfile Path Traversal
