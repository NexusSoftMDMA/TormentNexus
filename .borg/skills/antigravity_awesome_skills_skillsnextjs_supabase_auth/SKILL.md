---
name: antigravity_awesome_skills_skillsnextjs_supabase_auth
description: Curated skill skills/nextjs-supabase-auth from sickn33/antigravity-awesome-skills
---

# Antigravity Awesome Skills Skillsnextjs Supabase Auth
