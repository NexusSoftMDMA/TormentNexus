---
name: awesome_claude_skills_composio_skillscoinbase_automation
description: Curated skill composio-skills/coinbase-automation from ComposioHQ/awesome-claude-skills
---

# Awesome Claude Skills Composio Skillscoinbase Automation
