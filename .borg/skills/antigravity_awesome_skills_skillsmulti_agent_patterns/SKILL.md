---
name: antigravity_awesome_skills_skillsmulti_agent_patterns
description: Curated skill skills/multi-agent-patterns from sickn33/antigravity-awesome-skills
---

# Antigravity Awesome Skills Skillsmulti Agent Patterns
