# Task: Assimilate supabase MCP Server

## Goal
Fully assimilate the `supabase` MCP server into the native Go codebase.

## Details
- Type: SSE
- Command/URL: https://mcp.supabase.com/mcp?project_ref=qqnannkelftsgavibczq
- Args: []
