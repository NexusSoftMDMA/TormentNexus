# Task: Assimilate anyquery MCP Server

## Goal
Fully assimilate the `anyquery` MCP server into the native Go codebase.

## Details
- Type: STDIO
- Command/URL: anyquery
- Args: ['mcp', '--stdio', '--database', 'sqlite.db']
