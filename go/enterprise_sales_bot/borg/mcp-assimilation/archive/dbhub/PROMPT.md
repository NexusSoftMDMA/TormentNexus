# Task: Assimilate dbhub MCP Server

## Goal
Fully assimilate the `dbhub` MCP server into the native Go codebase.

## Details
- Type: STDIO
- Command/URL: npx
- Args: ['-y', '@bytebase/dbhub@latest', '--transport', 'stdio', '--dsn', 'postgres://user:password@localhost:5432/dbname']
