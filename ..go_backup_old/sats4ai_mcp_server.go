...
func HandleGetBitcoinPrice(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetRequest(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
